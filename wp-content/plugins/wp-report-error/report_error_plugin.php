...
function ReportPageErrors()
{
	...
	if($icon_hide)
	{
		...
		$wprpcode.= '<a class="wprperrorsform" href="#wprperrors">'.__('Report Error','wp-report-error').'</a>
		<div id="wrpbody" class="wrphidden"></div>
		<div id="wrpsubmitform">
		<h2 class="wrphead">'.__('Report Error','wp-report-error').'<img id="wrpcloseform" src="'.$plugin_url.'/images/close.png" alt="'.__('Close','wp-report-error').'" /></h2>
		...
		<p class="wprpsponsors">'.__('Brought to you by','wp-report-error').' <a href="http://www.daddydesign.com" title="Daddy Design" target="_blank">Daddy Design</a></p>
    </form>
</div>';
...
add_shortcode('WPRError', 'ReportPageErrors');
